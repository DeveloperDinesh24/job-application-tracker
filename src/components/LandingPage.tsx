...
export default function LandingPage({ onLoginClick }: LandingPageProps) {
  return (
    <div className='relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-slate-50 dark:bg-slate-950 px-6 transition-colors duration-500'>
      ...
      >
        {/* Badge styling */}
        <span className='px-4 py-1.5 rounded-full bg-blue-100/80 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-sm font-semibold mb-6 inline-block'>
          Beta Version 1.0
        </span>

        <h1 className='text-5xl md:text-7xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-6'>
          Stop losing track of your{' '}
          <span className='text-blue-600 dark:text-blue-500'>Future.</span>
        </h1>
